...
export const plans = [
  {
    ...
    cta: "Start Free",
    features: ["Basic workouts", "Basic habit tracking", "Basic progress"],
  },
  {
    id: "starter",
    name: "Starter",
    price: "₹99",
    tagline: "For your first consistent months.",
    cta: "Choose Starter",
    features: ["Personalized workouts", "Habit tracking", "Basic AI guidance"],
  },
  {
    id: "pro",
    name: "Pro",
    price: "₹299",
    tagline: "The complete Veyra system.",
    cta: "Choose Pro",
    highlight: true,
    features: [
      "Advanced workouts",
  ...
  },
  {
    ...
    name: "Elite",
    price: "₹699",
    tagline: "Maximum personalization.",
    cta: "Choose Elite",
    features: [
      "Full Veyra experience",

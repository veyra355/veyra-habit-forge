...
function buildWeeklyPlan(goal: string): WeeklyPlanDay[] {
  ...
  const mobility =
    text.includes("mobility") || text.includes("flexibility") || text.includes("move");
  ...
  const plans: Record<string, WeeklyPlanDay[]> = {
    strength: [
      ...
      },
      {
        ...
        duration: "20 min",
        tasks: ["10–15 min comfortable walk", "5 min gentle mobility", "Hydrate and recover"],
        reward: 80,
      },
      {
        day: "Day 3",
      ...
      },
      {
        ...
        duration: "15 min",
        tasks: ["10 min easy movement", "5 min mobility", "Keep your routine alive"],
        reward: 70,
      },
      {
        day: "Day 5",
        ...
        duration: "25 min",
        tasks: ["Warm-up", "Squats 3 × 12", "Glute bridge 3 × 12", "Calf raises 2 × 15"],
        reward: 140,
      },
      {
        day: "Day 6",
        ...
        tasks: [
          "Warm-up",
          "3 controlled rounds: squat, push-up, movement",
          "Rest between rounds",
          "Cooldown",
        ],
        reward: 160,
      ...
      {
        day: "Day 7",
        title: "Victory + Review",
        focus: "Recovery and reflection",
        duration: "20 min",
        tasks: ["Easy walk", "Gentle mobility", "Review your week", "Choose next week's target"],
        reward: 100,
      },
    ],
    fitness: [
      {
        ...
        duration: "20 min",
        tasks: ["5 min warm-up", "10 min easy circuit", "5 min cooldown"],
        reward: 100,
      },
      {
        day: "Day 2",
        ...
        duration: "20–25 min",
        tasks: ["Brisk but comfortable walk", "2–3 short faster intervals", "Cool down"],
        reward: 110,
      },
      {
        day: "Day 3",
        ...
        duration: "25 min",
        tasks: ["Squats 3 × 10", "Push-ups 3 × 8", "Glute bridge 3 × 12", "Mobility"],
        reward: 130,
      },
      {
        day: "Day 4",
        ...
        duration: "15–20 min",
        tasks: ["Easy walk", "Gentle mobility", "Relax and recover"],
        reward: 70,
      },
      {
        day: "Day 5",
        title: "Endurance XP",
        focus: "Steady movement",
        duration: "25–30 min",
        tasks: ["Warm-up", "20 min comfortable cardio", "Cooldown"],
        reward: 140,
      },
      {
        day: "Day 6",
        ...
        focus: "Full-body fitness",
        duration: "25 min",
        tasks: ["Warm-up", "3 rounds of controlled exercises", "Rest as needed", "Cooldown"],
        reward: 160,
      },
      {
        day: "Day 7",
        ...
        duration: "20 min",
        tasks: ["Easy walk", "Mobility", "Review progress", "Set next goal"],
        reward: 100,
      },
    ],
    mobility: [
      {
        ...
        duration: "15 min",
        tasks: ["Gentle warm-up", "Controlled joint movements", "Easy stretching"],
        reward: 90,
      },
      {
        day: "Day 2",
        ...
        duration: "15 min",
        tasks: ["Hip mobility", "Ankle mobility", "Gentle leg stretches"],
        reward: 90,
      },
      {
        day: "Day 3",
        ...
        duration: "15 min",
        tasks: ["Shoulder circles", "Thoracic mobility", "Gentle upper-body stretches"],
        reward: 90,
      },
      {
        day: "Day 4",
        ...
        focus: "Easy movement",
        duration: "15 min",
        tasks: ["Comfortable walk", "Gentle mobility", "Relaxed breathing"],
        reward: 70,
      },
      {
        day: "Day 5",
        ...
        duration: "20 min",
        tasks: ["Warm-up", "Controlled single-leg balance", "Mobility flow"],
        reward: 100,
      },
      {
        day: "Day 6",
        ...
        focus: "Full-body mobility",
        duration: "20 min",
        tasks: ["Warm-up", "Full-body mobility sequence", "Easy cooldown"],
        reward: 120,
      },
      {
        day: "Day 7",
        ...
        focus: "Recovery + consistency",
        duration: "15 min",
        tasks: ["Easy movement", "Favorite mobility drills", "Review how you feel"],
        reward: 90,
      },
    ],
    habits: [
      {
        day: "Day 1",
        title: "Start Small",
        focus: "Build your routine",
        duration: "15 min",
        tasks: [
          "Complete one movement quest",
          "Drink water regularly",
          "Set tomorrow's workout time",
        ],
        reward: 80,
      },
      {
        ...
        focus: "Consistency",
        duration: "15 min",
        tasks: ["Complete today's movement", "Protect your sleep routine", "Check off your habits"],
        reward: 80,
      },
      {
        day: "Day 3",
        title: "No Zero Day",
        focus: "Minimum viable workout",
        duration: "15 min",
        tasks: ["Do a short workout", "Take a walk", "Complete one habit"],
        reward: 90,
      },
      {
        day: "Day 4",
        title: "Reset",
        focus: "Recovery habits",
        duration: "15 min",
        tasks: ["Easy movement", "Prepare tomorrow", "Review your streak"],
        reward: 70,
      },
      {
        day: "Day 5",
        title: "Level Up",
        focus: "Routine strength",
        duration: "20 min",
        tasks: ["Complete workout", "Complete 3 priority habits", "Avoid skipping the basics"],
        reward: 110,
      },
      {
        day: "Day 6",
        ...
        duration: "20 min",
        tasks: ["Complete movement quest", "Keep your routine", "Plan next week"],
        reward: 110,
      },
      {
        day: "Day 7",
        ...
        focus: "Review + reward",
        duration: "15 min",
        tasks: ["Easy movement", "Review completed habits", "Pick one improvement for next week"],
        reward: 100,
      },
    ],
    balanced: [
      {
        ...
        focus: "Full-body fitness",
        duration: "20 min",
        tasks: ["Warm-up", "Squats 3 × 10", "Push-ups 3 × 8", "Cooldown"],
        reward: 110,
      },
      {
        day: "Day 2",
        ...
        duration: "20 min",
        tasks: ["Comfortable walk", "Gentle mobility", "Hydrate and recover"],
        reward: 80,
      },
      {
        day: "Day 3",
        ...
        duration: "25 min",
        tasks: ["Warm-up", "Squats 3 × 12", "Push-ups 3 × 8–12", "Glute bridge 3 × 12"],
        reward: 130,
      },
      {
        day: "Day 4",
        ...
        focus: "Recovery",
        duration: "15 min",
        tasks: ["Easy movement", "Mobility", "Prepare for tomorrow"],
        reward: 70,
      },
      {
        day: "Day 5",
        title: "Level Up",
        focus: "Fitness circuit",
        duration: "25 min",
        tasks: ["Warm-up", "3 controlled rounds", "Rest as needed", "Cooldown"],
        reward: 140,
      },
      {
        day: "Day 6",
      ...
      },
      {
        ...
        focus: "Recovery",
        duration: "20 min",
        tasks: ["Easy walk", "Gentle mobility", "Review your week", "Set next week's goal"],
        reward: 100,
      },
    ],
  };
  ...
  return (
    <div className="relative pb-10">
      ...
      <section className="relative overflow-hidden rounded-[30px] border border-primary/20 bg-gradient-to-br from-primary/10 via-card to-background p-5 shadow-2xl sm:p-7">
        ...
        <div className="relative grid gap-7 lg:grid-cols-[1fr_0.7fr] lg:items-center">
          ...
          <div className="rounded-[26px] border border-border/70 bg-background/55 p-5 backdrop-blur-xl">
            ...
            <Progress
              value={Math.min(100, levelProgress + (earnedQuestXp / Math.max(1, levelRange)) * 100)}
              className="mt-2 h-3"
            />
            <div className="mt-4 grid grid-cols-3 gap-2">
              ...
              <HudStat
                icon={Trophy}
                value={`${completed.length}/${quests.length}`}
                label="cleared"
              />
            </div>
          </div>
      ...
      <section className="mt-7 rounded-[26px] border border-primary/15 bg-card/70 p-5 shadow-lg sm:p-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Veyra converted your goal into today's quest path.
            </p>
          </div>
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <span
                    className={`flex size-10 items-center justify-center rounded-xl ${done ? "bg-primary text-primary-foreground" : "bg-secondary text-primary"}`}
                  >
                    {done ? (
        ...
        >
          <Trophy className="mr-2 size-4" /> View 7-day plan
        </Button>
      </section>
      ...
      <section className="mt-7 grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="grid gap-0 md:grid-cols-[0.9fr_1.1fr]">
            <div className="relative min-h-[300px] overflow-hidden bg-gradient-to-br from-primary/10 via-background to-secondary/30 p-5">
              ...
              <div className="absolute bottom-4 left-4 right-4 rounded-xl border border-border/70 bg-background/80 p-3 text-xs backdrop-blur">
                <span className="font-bold text-primary">FORM FIRST</span> · Move slowly enough to
                keep control.
              </div>
            </div>
            <div className="p-5">
              ...
              <div className="mt-4 flex items-start gap-3 rounded-2xl border border-border p-4">
                ...
                <p className="text-xs leading-5 text-muted-foreground">
                  Stop if you feel pain, dizziness or unusual symptoms. Veyra is general wellness
        ...
        <div className="space-y-5">
          <div className="rounded-[28px] border border-border bg-card p-5 shadow-lg">
            ...
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              Keep today simple: finish one quest, learn the movement, then decide whether you want
              to continue. Consistency beats an overloaded plan.
            </p>
      ...
      <SafetyNote>
        ...
        treat injuries. For symptoms, pain, medication or medical questions, consult a qualified
          ...
          <div className="w-full max-w-xl rounded-[30px] border border-primary/20 bg-card p-6 shadow-2xl sm:p-8">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h2 id="goal-title" className="mt-3 text-2xl font-black">
                  What do you want to achieve?
                </h2>
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  Type it naturally. Veyra will build a personalized 7-day plan from your goal.
                </p>
              </div>
              <Button
                variant="ghost"
            ...
            <textarea
              ...
              placeholder="Example: I want to build strength and stay consistent…"
            ...
            >
              Generate 7-day plan <Sparkles className="ml-2 size-4" />
            </Button>
            <p className="mt-3 text-center text-[11px] text-muted-foreground">
              Your plan is generated locally from the goal; no API secret is exposed.
            </p>
          </div>
        </div>
      )}
      ...
      {weeklyPlanOpen && (
        <div
          className="fixed inset-0 z-[60] overflow-y-auto bg-background/90 p-4 backdrop-blur-md"
          role="dialog"
          aria-modal="true"
          aria-labelledby="weekly-plan-title"
        >
          <div className="mx-auto my-6 w-full max-w-5xl rounded-[30px] border border-primary/20 bg-card p-5 shadow-2xl sm:p-8">
            <div className="flex items-start justify-between gap-4">
              <div>
                <Badge className="rounded-full bg-primary/10 text-primary hover:bg-primary/10">
                  7-DAY QUEST PLAN
                </Badge>
                <h2 id="weekly-plan-title" className="mt-3 text-2xl font-black sm:text-3xl">
                  {activeGoal}
                </h2>
                <p className="mt-2 text-sm text-muted-foreground">
                  A balanced week built around your goal. Start with Day 1 and unlock the next
                  mission as you go.
                </p>
              </div>
              <Button
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {weeklyPlan.map((item, index) => (
                <div
                  key={item.day}
                  className={`rounded-2xl border p-4 ${index === 0 ? "border-primary/50 bg-primary/5" : "border-border bg-background/40"}`}
                >
                  <div className="flex items-center justify-between">
                    <Badge variant={index === 0 ? "default" : "outline"}>{item.day}</Badge>
                    <span className="text-xs font-bold text-primary">+{item.reward} XP</span>
                  </div>
                  ...
                  <ul className="mt-3 space-y-2">
                    {item.tasks.map((task) => (
                      <li key={task} className="flex gap-2 text-xs leading-5 text-muted-foreground">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <Button className="flex-1 rounded-2xl" onClick={() => setWeeklyPlanOpen(false)}>
                <Gamepad2 className="mr-2 size-4" /> Start Day 1
              </Button>
              <Button
                variant="outline"
